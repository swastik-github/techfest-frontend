  ...
  return (
    <div className={classes.container}>
        ...
        <div className={classes.site_card_wrapper}>
          ...
          >
            <Image width={380} height={250} src={"/images/coding.jpg"} alt="hefd" />
          ...
          <Card
            ...
            className={classes.cardss}
          >
            <Image width={380} height={250} src={"/images/playing.jpg"} alt="hefd" />
            <div className={classes.headLine}>
              <h3> Sport Event </h3>
            </div>
            <div className={classes.explore}>
          ...
          <Card
            ...
            className={classes.cardss}
          >
            <Image width={380} height={250} src={"/images/dancing.jpg"} alt="hefd" />
            <div className={classes.headLine}>
        ...
        <div
          ...
          className={classes.site_card_wrapper}
        >
          <Card
            bordered={false}
